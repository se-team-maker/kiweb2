    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <?php else: ?>
                    <h1>アカウント作成</h1>
                    <p class="subtitle">京都医塾アカウントを作成</p>
                <?php endif; ?>
            </div>
            ...
            <form id="signup-form" action="/kiweb/login/api/register.php" method="POST" novalidate>
                ...
                <div class="md-text-field">
                    ...
                    <label for="password_confirm">確認</label>
                </div>
                ...
                <div class="action-area">
                    <a href="login.php" class="text-btn">ログインはこちら</a>
