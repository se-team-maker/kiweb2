...
define('KIWEB_ROOT', dirname(__DIR__, 4));
...
Dotenv::createImmutable(AUTH_APP_ROOT)->safeLoad();
...
try {
    $result = DeclarationScheduleCacheRefresher::refresh(AUTH_STORAGE_ROOT . '/declaration_schedule_cache.json');
    respondJson_([
        'success' => true,
