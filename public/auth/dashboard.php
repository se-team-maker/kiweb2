...
<body>
    <div class="dashboard-container">
        <header class="dashboard-header">
            ...
            <div class="user-info">
                ...
                <a href="/kiweb/public/auth/logout.php" class="btn btn-secondary">ログアウト</a>
            </div>
        </header>
        ...
        <div class="dashboard-card">
            ...
            <?php if (empty($passkeys)): ?>
                <p style="color: var(--text-secondary); margin-bottom: 16px;">
                    パスキーは登録されていません。パスキーを登録すると、指紋やFace IDでログインできます。
                </p>
            <?php else: ?>
    ...
    <script src="/kiweb/public/auth/assets/js/dashboard.js"></script>
    <script>
