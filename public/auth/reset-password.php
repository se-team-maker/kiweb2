<?php
/**
 * 繝代せ繝ｯ繝ｼ繝牙・險ｭ螳壹・繝ｼ繧ｸ・医さ繝ｼ繝牙・蜉・+ 譁ｰ繝代せ繝ｯ繝ｼ繝芽ｨｭ螳夲ｼ・
 */
...
// token_id 繧旦RL繝代Λ繝｡繝ｼ繧ｿ縺九ｉ蜿門ｾ・
$tokenId = $_GET['id'] ?? '';

// 繝医・繧ｯ繝ｳ諠・ｱ繧貞叙蠕暦ｼ医Γ繝ｼ繝ｫ繧｢繝峨Ξ繧ｹ陦ｨ遉ｺ逕ｨ・・
$tokenInfo = null;
$email = '';
if ($tokenId) {
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="/kiweb/public/auth/assets/css/style.css">
    <style>
...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-header">
                <img src="/kiweb/public/auth/京都医塾logo.png" alt="京都医塾" class="logo">
            ...
            <div id="step1" class="step active">
                <form id="verify-form">
                    ...
                    <div class="action-area">
                        <a href="/kiweb/public/auth/login.php" class="text-btn">戻る</a>
            ...
            <div id="step2" class="step">
                <form id="reset-form" novalidate>
                    ...
                    <div class="md-text-field">
                        ...
                        <label for="new_password_confirm">パスワード（確認）</label>
                    </div>
    ...
    <script src="/kiweb/public/auth/assets/js/progress.js"></script>
    <script src="/kiweb/public/auth/assets/js/login.js"></script>
    <script>
        ...
        [newPasswordInput, newPasswordConfirmInput].forEach((input) => {
            ...
            input.addEventListener('input', (event) => {
                applyHalfWidthFilter(input, event);
        ...
        const applyHalfWidthFilter = (input, event) => {
            if (!input || (event && event.isComposing)) {
                return;
            }
        ...
        function goToStep2() {
            ...
            pageSubtitle.textContent = '新しいパスワードを入力してください';
        ...
        verifyForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                const response = await fetch('/kiweb/public/auth/api/password-reset-verify.php', {
                    method: 'POST',
                    body: formData,
        ...
        resetForm.addEventListener('submit', async function (e) {
            ...
            if (newPassword !== newPasswordConfirm) {
                setFieldError(document.getElementById('new_password_confirm'), 'パスワードが一致しません。もう一度入力してください。');
                return;
            }
            ...
            try {
                ...
                const response = await fetch('/kiweb/public/auth/api/password-reset-complete.php', {
                    method: 'POST',
                    body: formData,
                    credentials: 'same-origin'
                });
        ...
        resendLink.addEventListener('click', async function () {
            ...
            try {
                ...
                const response = await fetch('/kiweb/public/auth/api/resend-verify.php', {
                    method: 'POST',
                    body: formData,
                    credentials: 'same-origin'
                });
                ...
                if (data.success) {
                    if (data.token_id) {
                        ...
                        history.replaceState(null, '', '/kiweb/public/auth/reset-password.php?id=' + data.token_id);
                    }
