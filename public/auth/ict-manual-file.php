...
{
    return defined('AUTH_ICT_MANUAL_ROOT')
        ? AUTH_ICT_MANUAL_ROOT
        : dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'Documents' . DIRECTORY_SEPARATOR . 'ict-manual';
}
