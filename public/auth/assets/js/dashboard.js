...
async function registerPasskey() {
    ...
    try {
        // 逋ｻ骭ｲ繧ｪ繝励す繝ｧ繝ｳ繧貞叙蠕・
        const optionsResponse = await fetch('/kiweb/public/auth/api/webauthn/register-options.php', {
            method: 'POST',
            headers: {
        ...
        const verifyResponse = await fetch('/kiweb/public/auth/api/webauthn/register-verify.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-Token': window.csrfToken
...
async function deletePasskey(credentialId) {
    try {
        const response = await fetch('/kiweb/public/auth/api/webauthn/delete.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-Token': window.csrfToken
