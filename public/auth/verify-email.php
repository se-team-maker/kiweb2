...
<body>
    ...
    <div class="verification-card">
        ...
        <div class="logo-section">
            <img src="/kiweb/public/auth/京都医塾logo.png" alt="京都医塾" onerror="this.style.display='none'">
        </div>
        ...
        <!-- コード入力フォーム -->
        <form id="verify-form" action="/kiweb/public/auth/api/verify-email.php" method="POST">
