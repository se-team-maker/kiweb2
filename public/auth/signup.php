...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <form id="signup-form" action="/kiweb/public/auth/api/register.php" method="POST" novalidate>
                ...
                <!-- ====== 変更後 ====== -->
                    ...
                    <div class="field-error" id="error-last_name" role="alert" aria-live="polite"></div>
                    <div class="field-error" id="error-first_name" role="alert" aria-live="polite"></div>
