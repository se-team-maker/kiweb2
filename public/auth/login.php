...
if ($nameParam !== '') {
    ...
    header('Location: /kiweb/public/auth/signup.php?' . $query);
    exit;
}
...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <div id="auth-content">
                <form id="password-form" class="auth-form active" action="/kiweb/public/auth/api/login.php" method="POST" novalidate>
