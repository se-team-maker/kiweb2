...
var FIXED_API_URL = 'https://system.kyotoijuku.com/kiweb/public/user/api/teachers.php';
var FIXED_USER_SYNC_SECRET = 'rloCfUjjkDtM9UGBh54f4Dd5MtOoYzFmsK78mX20q9pow56Hnd117ne6X3kV8bXI';
...
function getConfig_() {
  if (!FIXED_USER_SYNC_SECRET || FIXED_USER_SYNC_SECRET.length < 32) {
    throw new Error('FIXED_USER_SYNC_SECRET must be 32+ chars');
  }

  return {
    apiUrl: FIXED_API_URL,
    secret: FIXED_USER_SYNC_SECRET,
