            ...
            <div id="step1" class="step active">
                <form id="verify-form">
                    ...
                    <div class="action-area">
                        <a href="/kiweb/teacher-auth/public/login.php" class="text-btn">戻る</a>
    ...
    <script>
        ...
        verifyForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                const response = await fetch('/kiweb/teacher-auth/api/password-reset-verify.php', {
                    method: 'POST',
                    body: formData,
        ...
        resetForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                const response = await fetch('/kiweb/teacher-auth/api/password-reset-complete.php', {
                    method: 'POST',
                    body: formData,
                    credentials: 'same-origin'
                });
            ...
            try {
                ...
                if (data.success) {
                    if (data.token_id) {
                        ...
                        history.replaceState(null, '', '/kiweb/teacher-auth/public/reset-password.php?id=' + data.token_id);
                    }
